    ...
    return (
      <div className="header__in">
        <header className="header__head">
          ...
          <nav className={
            classnames("nav", this.state.open && "open")
          }>
            <ul>
              {
                list.map(item => <li>
              ...
              <li>
                <a className="nav__link" target="_blank" href="https://www.facebook.com/E-Health-323399904773248">
                  <i className="icon icon_name_fb"></i>
                </a>
              </li>
              <li>
                <a className="nav__link" target="_blank" href="https://twitter.com/eHealthUa">
                  <i className="icon icon_name_tw"></i>
                </a>
              </li>
            </ul>
          </nav>
        ...
        <footer className="header__footer">
          <a className="header__main-link" href="about.html">
            докладніше
            <i className="icon icon_name_arrow-right"></i>
          </a>
        </footer>
      </div>
    )
